...
**apidoc-go** एक सामान्य-उद्देश्य Go API दस्तावेज़ प्लगइन लाइब्रेरी है: इंटरफ़ेस दस्तावेज़ों को **टाइप किए गए स्ट्रक्ट्स** के रूप में रूट पंजीकरण के साथ ही घोषित किया जाता है — दस्तावेज़ और रूट एक साथ जन्म लेते हैं; एम्बेडेड Web UI ऑनलाइन ब्राउज़िंग और ऑनलाइन डिबगिंग प्रदान करता है, और इसमें पासवर्ड प्रमाणीकरण, बहु-ऐप / बहु-संस्करण प्रबंधन, Mock डेटा तथा JSON / TypeScript निर्यात क्षमताएँ, तथा एनोटेशन ऑटो-पार्सिंग, HTTP कैशिंग और स्वचालित पैरामीटर पूर्ति अंतर्निहित हैं। एक बार जोड़ें, सभी फ्रेमवर्क पर काम करे — मौजूदा प्रोजेक्ट में किसी बदलाव की आवश्यकता नहीं।
...
| 11 | HTTP कैशिंग | ETag + 304, डॉक रिस्पॉन्स तुरंत खुलते हैं |
| 12 | स्वचालित पैरामीटर पूर्ति | reflect हैंडलर सिग्नेचर से रिक्वेस्ट पैरामीटर का अनुमान लगाता है |
...
├── parse/               # एनोटेशन ऑटो-पार्सर
│   └── parse.go         #   go/ast · @apidoc कमेंट मार्कर
├── export/              # निर्यात
...
### स्वचालित पैरामीटर पूर्ति (reflect)
जब `Doc.Params` खाली होता है, Register हैंडलर सिग्नेचर से reflect द्वारा पैरामीटर का अनुमान लगाता है: स्ट्रक्ट आर्ग्युमेंट body फ़ील्ड में विस्तारित होते हैं (json टैग के अनुसार), और फ्रेमवर्क कॉन्टेक्स्ट (gin.Context / echo.Context / fiber.Ctx) स्वतः छोड़ दिए जाते हैं।

### HTTP कैशिंग (ETag)
सभी डॉक एंडपॉइंट स्वतः `ETag` + `Cache-Control: private, max-age=300` लेकर चलते हैं; बार-बार विज़िट पर 304 मिलता है। किसी कॉन्फ़िगरेशन की आवश्यकता नहीं।

### निर्यात
| फ़ॉर्मेट | एंडपॉइंट | विवरण |
|--------|----------|------|
| JSON | `GET /apidoc/api/export` | संपूर्ण प्रोजेक्ट ट्री |
| TypeScript | `GET /apidoc/api/export?format=typescript` | इंटरफ़ेस प्रकार परिभाषाएँ |
